...
#define TOUCH_THRESHOLD_H 23
#define TOUCH_THRESHOLD_L 16
...
boolean bIsPressedNowEdge(bool *bTouchPressedNow) {
  ...
  boolean bTouchIsPressed[2] = {(nTouch[0] < TOUCH_THRESHOLD_H) && (nTouch[0] > TOUCH_THRESHOLD_L) , (nTouch[1] < TOUCH_THRESHOLD_H)&&(nTouch[1] > TOUCH_THRESHOLD_L)};
